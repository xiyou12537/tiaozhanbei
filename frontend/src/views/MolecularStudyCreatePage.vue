  ...
  <div class="study-create-page">
    ...
    <main class="builder">
      <section v-show="activeStep === 0" class="step-panel">
        ...
        <div class="form-grid four"><el-form-item label="活性空间轨道数"><el-input-number v-model="form.activeSpaceOrbitals" :min="1" :max="6"/></el-form-item><el-form-item label="Pauli 截断阈值"><el-input-number v-model="form.pauliCoefficientCutoff" :precision="8" :step="0.000001"/></el-form-item><el-form-item label="VQE 层数"><el-input-number v-model="form.ansatzLayers" :min="1" :max="4"/></el-form-item><el-form-item label="VQE 迭代预算"><el-input-number v-model="form.maxIterations" :min="1" :max="500"/></el-form-item></div>
      </section>
      ...
      <section v-show="activeStep === 1" class="step-panel">
        ...
        <article v-for="(architecture, architectureIndex) in form.architectures" :key="architectureIndex" class="architecture-editor">
