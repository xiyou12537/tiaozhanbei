...
.study-result-page{gap:24px}.result-head,.study-overview,.study-decision,.study-evidence,.panel{border-radius:var(--lz-radius);box-shadow:var(--lz-shadow)}.result-head{background:var(--lz-bg-soft)}.result-head h2{line-height:var(--lz-title-leading);letter-spacing:-.045em}.result-head p,.study-overview p{line-height:var(--lz-body-leading)}.study-overview{border-color:#c6ddd1;background:var(--lz-accent-soft)}.study-overview span,.simulation-note{color:var(--lz-accent-deep)!important}.overview-metrics article,.science-grid article,.energy-row article,.detail-grid article{background:var(--lz-panel)}.panel{padding:var(--lz-space-panel)}.study-evidence{overflow:hidden}.study-evidence>summary{padding:19px 22px}.study-evidence-body{padding:22px}.evaluation-detail{border-left-color:var(--lz-accent)}.contract-tags :deep(.el-tag){border-color:#b8d2c5;background:var(--lz-accent-soft);color:var(--lz-accent-deep)}.contract-tags :deep(.el-tag--warning){border-color:#ebcf94;background:#fff6e5;color:#855a16}
</style>
