...
const routes = [
  ...
  { path: '/register', redirect: '/auth?tab=register' },
  {
    ...
    component: AppLayout,
    children: [
      { path: '', component: WorkbenchPage, meta: { title: '工作台', eyebrow: '分子计算工作台' } },
      { path: 'molecules', component: MoleculesPage, meta: { title: '新建分子计算', eyebrow: '创建任务' } },
      { path: 'molecule-workflows', component: MoleculeWorkflowHistoryPage, meta: { title: '计算任务', eyebrow: '任务记录' } },
      { path: 'molecule-workflows/:workflowId', component: MoleculeWorkflowResultPage, meta: { title: 'Workflow 结果', eyebrow: '执行证据' } },
      { path: 'molecular-studies/new', component: MolecularStudyCreatePage, meta: { title: '新建部署评估', eyebrow: '方案比较' } },
      { path: 'molecular-studies/:studyId', component: MolecularStudyResultPage, meta: { title: '部署评估报告', eyebrow: '比较报告' } },
      { path: 'molecular-bond-scans/new', component: MolecularBondScanCreatePage, meta: { title: '新建势能扫描', eyebrow: '键长扫描' } },
      { path: 'molecular-bond-scans/:scanId', component: MolecularBondScanResultPage, meta: { title: '势能扫描结果', eyebrow: '扫描报告' } },
      { path: 'simulation-capabilities', component: SimulationCapabilitiesPage, meta: { title: '模拟能力说明', eyebrow: '能力边界' } },
      { path: 'copilot', component: MolecularCopilotPage, meta: { title: 'Molecular Copilot', eyebrow: '受控助手' } },
    ],
  },
